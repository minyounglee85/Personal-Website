...
<div class="container">
  <div class="header">
    <?print_outlogin("default","1","10");?><a href="product.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Product','','img/introbtnR.jpg',1)"><img src="img/introbtn.jpg" alt="" width="172" height="50" id="Product" border = "0"></a><a href="Recommand.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Recommand','','img/recommbtnR.jpg',1)"><img src="img/recommbtn.jpg" border = "0" width="170" height="50" id="Recommand"></a><a href="event.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Event','','img/eventbtnR.jpg',1)"><img src="img/eventbtn.jpg" border = "0" width="170" height="50" id="Event"></a><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('News','','img/newsbtnR.jpg',1)"><img src="img/newsbtn.jpg" name="News"  border = "0" width="170" height="50" id="News"></a><a href="community.php?str=http://chin1927.dothome.co.kr/bbs/zboard.php?id=Notice" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Community','','img/commubtnR.jpg',1)"><img src="img/commubtn.jpg" alt="" width="170" height="50" id="Community"  border = "0"></a><a href="support.php?str=http://chin1927.dothome.co.kr/bbs/zboard.php?id=FAQ" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Support','','img/supportbtnR.jpg',1)"><img src="img/supportbtnR.jpg" name="Support" width="170" height="50" id="Support" border = "0"></a></p>
  </div>
  <div class="sidebar"><!-- end .container -->
    <table width="175" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><img src="img/submenu/support.jpg" width="171" height="25"></td>
      </tr>
      <tr>
      <td><img src="img/submenu/line.jpg" width="171" height="6" style="vertical-align:baseline"></td>
      </tr>
      <tr>
        <td><div align="left" style="font-size:14px"><a href="support.php?str=http://chin1927.dothome.co.kr/bbs/zboard.php?id=FAQ" style="color:#999; text-decoration:none;" onMouseOver='this.style.color="#000"' onMouseOut='this.style.color="#999"'>FAQ</a></div></td>
      </tr>
      <tr>
        <td><div align="left" style="font-size:14px"><a href="support.php?str=http://chin1927.dothome.co.kr/bbs/zboard.php?id=Qna" style="color:#999; text-decoration:none;" onMouseOver='this.style.color="#000"' onMouseOut='this.style.color="#999"'>QnA</a></div></td>
      </tr>
      <tr>
        <td><div align="left" style="font-size:14px"><a href="support.php?str=FormMail.php" style="color:#999; text-decoration:none;" onMouseOver='this.style.color="#000"' onMouseOut='this.style.color="#999"'>Send Mail</a></div></td>
      </tr>
      <tr>
        <td><div align="left"></div></td>
      </tr>
  ...
  <div style="position:relative;top:0;left:0;">
	...
	<? echo "<iframe name='naver' frameBorder='0' src =$type scrolling='yes' id='wsp_49364a9'></iframe></div>" ?><img src="img/footer.jpg" width="1024" height="100" border="0" usemap="#Map">
	<map name="Map">

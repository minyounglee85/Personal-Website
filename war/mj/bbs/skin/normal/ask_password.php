...
.askPass {font:12px ±¼¸²; color:#333; text-align:center; padding:10px;}
...
<table width="300px" cellSpacing="0" cellpadding="0" border="0" class="askTb">
	...
	<?if(!$member[no]) {?>
	<tr>
		<td class="askTitle">ºñ¹Ð¹øÈ£ : <?=$input_password?></td>
	</tr>
	<?}?>
	<tr>
		<td class="askBtn">
		<span class="button"><input type="submit" value="OK" /></span>
		<a class="button" href="#" onclick="history.go(-1); return false;" title="Ãë¼Ò"><span>Ãë¼Ò</span></a></td>
	</tr>
</table>

...
<table width="300px" cellSpacing="0" cellpadding="0" border="0" class="askTb">
	...
	<?if(!$url) {?>
	<tr>
		<td class="askBtn"><a class="button" href="#" onclick="history.go(-1); return false;" title="µÚ·Î"><span>µÚ·Î</span></a></td>
	</tr>
	<?}else{?>
	<tr>
		<td class="askTitle"><a class="button" href="#" onclick="location.href='<?echo $url;?>'" title="ÀÌµ¿"><span>ÀÌµ¿</span></a></td>
	</tr>
	<?}?>
</table>

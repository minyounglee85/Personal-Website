...
<tr>
  ...
  <td>&nbsp;<input type=text name=from size=20 maxlength=20 class=input style=border-color:#4374D9></td>
</tr>
<tr>
  <Td align=right><img src=images/vi_email.gif></td>
  <td>&nbsp;<input type=text name=email size=40 maxlength=80 class=input style=border-color:#4374D9></td>
</tr>
<?
 }
?>
<tr>
  ...
  <td>&nbsp;<input type=text style=width:80% name=subject class=input style=border-color:#4374D9> <input type=hidden name=html value=0></td>
</tr>
<tr>
  <td colspan=2 align=center><textarea name=memo class=textarea rows=21 style=width:100%;border-color:#4374D9></textarea></td>
</tr>
<tr>

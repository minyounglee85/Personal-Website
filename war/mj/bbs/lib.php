		...
		if($setup[skinname]) {
			...
			<tr>
				<td align=right style=font-family:tahoma,굴림;font-size:8pt;line-height:150%;letter-spacing:0px>
					<font style=font-size:7pt>Copyright 2012-<?=date("Y")?></font> <a href=http://chin1927.dothome.co.kr target=_blank onfocus=blur()><font style=font-family:tahoma,굴림;font-size:8pt;>MJ Homme, Ajou Univ.</a>
				</td>   
			</tr>
			</table>

...
<?print_outlogin("default","1","10");?>
  ...
  <p>&nbsp;</p>
  <p><img src="img/recommand/STEP25.jpg" width="556" height="597" border="0" usemap="#Map2">
    <map name="Map2">
      <area shape="rect" coords="45,315,268,544" href="product.php#gunsung">
      <area shape="rect" coords="302,316,525,543" href="#">
    </map>
  </p>
  <p>&nbsp;</p>
